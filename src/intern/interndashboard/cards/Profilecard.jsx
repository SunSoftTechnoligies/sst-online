  ...
  return (
    <div>
      <div className="max-w-md mx-4 p-6 bg-white rounded-lg shadow-lg transition-transform transform hover:scale-105">
        ...
        />
        <button
        onClick={doPerformfunction}
          className="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold p-2 rounded-full square-button transition duration-300 transform hover:scale-105 focus:outline-none"
        >
          Profile
        </button>
      </div>
